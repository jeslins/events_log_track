INTRODUCTION
------------
This module track logs of specific events that you'd like to log. The events are
saved in the database and can be viewed on the page admin/reports/events-track.
You could use this to track number of times the CUD operation performed by
which users.
